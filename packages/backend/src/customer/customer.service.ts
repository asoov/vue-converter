...
import { handleStripeEvent, checkStripeSignatureAndReturnEvent } from './customer.functions';
...
export class CustomerService {
  ...
  public async chargeAccountTokenBalance({ request, headers }: ChargeCustomerTokensDTO) {
